...
export default function PharmacyVisit() {
  ...
  if (p.loading) {
    return (
      <div className="max-w-5xl mx-auto px-6 py-20 flex items-center gap-2 text-slate-400">
        <Loader2 className="animate-spin" size={18} /> Loading pharmacy dashboard…
      </div>
    )
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-14">
      <h1 className="text-3xl font-extrabold text-ink-900">Pharmacy Visit</h1>
      <p className="mt-2 text-slate-500">Medication review and patient-specific safety intelligence.</p>
      ...
      <div className="mt-8 rounded-2xl border border-teal-100 bg-teal-50/40 p-6 grid sm:grid-cols-2 gap-6">
        <div>
          ...
          <p className="text-sm text-slate-500">{p.profile?.age} Years</p>
        </div>
        <div>
